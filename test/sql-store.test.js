...
var pgConnectionString = 'postgresql://postgres@127.0.0.1/logux_test'

var SQLStore = require('../sql-store')
...
it('fails without connection info', function () {
  store = new SQLStore()
